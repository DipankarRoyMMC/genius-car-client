    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 left-5 top-1/4">
                <h1 className='font-bold text-6xl text-white !important'>Affordable <br></br>Price For Car<br></br> Servicing</h1>
            </div>
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 left-5 top-3/4">
                <button className="btn btn-outline btn-warning bg-red-500 border-0 text-white mr-3">Discover More</button>
